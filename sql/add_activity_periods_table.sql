-- Add Activity Periods Table for Idle Time Tracking
-- This table was missing from the initial setup and is needed to track active vs idle time

BEGIN;

-- Create the activity periods table
...
SELECT 'Activity Periods table:' as status;
